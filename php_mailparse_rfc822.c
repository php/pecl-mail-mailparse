/* Generated by re2c 1.1.1 on Wed Sep  1 12:17:58 2021 */
#line 1 "ext\\mailparse\\php_mailparse_rfc822.re"
/*
   +----------------------------------------------------------------------+
...
#line 36 "ext\\mailparse\\php_mailparse_rfc822.re"


#line 45 "ext\\mailparse\\php_mailparse_rfc822.re"
...
#line 71 "<stdout>"
{
	...
	static const unsigned char yybm[] = {
		 ...
		 80,  96,  96,  80,  80,  96,  80,  80, 
		 80,  80,  80,  80,  80,  80,  80,  80, 
		 80,  80,  80,  80,  80,  80,  80,  80, 
		 96,  64,   0,  80,  80,  64,  80,  80, 
		 64,  64,  80,  80,  64,  80,  64,  64, 
		 80,  80,  80,  80,  80,  80,  80,  80, 
		 80,  80,  64,  64,  64,  64,  64,  64, 
		 64,  80,  80,  80,  80,  80,  80,  80, 
		 80,  80,  80,  80,  80,  80,  80,  80, 
		 80,  80,  80,  80,  80,  80,  80,  80, 
		 80,  80,  80,  64, 144,  64,  80,  80, 
		 80,  80,  80,  80,  80,  80,  80,  80, 
		 80,  80,  80,  80,  80,  80,  80,  80, 
		 80,  80,  80,  80,  80,  80,  80,  80, 
		 80,  80,  80,  80,  80,  80,  80,  80, 
...
yy2:
	++YYCURSOR;
#line 87 "ext\\mailparse\\php_mailparse_rfc822.re"
	{	goto stop; }
#line 161 "<stdout>"
yy4:
	++YYCURSOR;
...
#line 141 "ext\\mailparse\\php_mailparse_rfc822.re"
	{	DBG_STATE("ANY");
							if (tokens) {
								tokens->token = 0;
...
#line 88 "ext\\mailparse\\php_mailparse_rfc822.re"
	{ 	DBG_STATE("SPACE"); goto state_ground; }
#line 190 "<stdout>"
yy10:
	++YYCURSOR;
#line 140 "ext\\mailparse\\php_mailparse_rfc822.re"
...
yy15:
	++YYCURSOR;
#line 90 "ext\\mailparse\\php_mailparse_rfc822.re"
...
yy17:
	++YYCURSOR;
yy18:
#line 89 "ext\\mailparse\\php_mailparse_rfc822.re"
	{ 	REPORT_ERR("token not valid in ground state"); goto state_ground; }
#line 226 "<stdout>"
yy19:
	yych = *++YYCURSOR;
	if (yych == '>') goto yy28;
#line 122 "ext\\mailparse\\php_mailparse_rfc822.re"
	{ 	DBG_STATE("LANGLE");
							if (in_bracket) {
...
yy21:
	++YYCURSOR;
#line 131 "ext\\mailparse\\php_mailparse_rfc822.re"
	{	DBG_STATE("RANGLE");
							if (!in_bracket) {
...
yy24:
	++YYCURSOR;
yy25:
#line 98 "ext\\mailparse\\php_mailparse_rfc822.re"
...
yy28:
	++YYCURSOR;
#line 109 "ext\\mailparse\\php_mailparse_rfc822.re"
	{	DBG_STATE("NULL <>");
							ADD_ATOM_TOKEN();
							if (tokens) {
								tokens->token = 0;
...
#line 151 "ext\\mailparse\\php_mailparse_rfc822.re"
